...
作者的答案浓缩成一个词就是「真知识」，通俗的讲就是那些能够帮助生活，而且能够像滚雪球一样慢慢壮大的全局认识。
...
全局认识，又称全局理解（Big understandings），指的是那些能够帮我们理解世界，与生活息息相关的「业余专家知识」。或者换一种说法，信息以网状结构分布，全局认识就是一个联通尽量多节点的小网。

想象一下走在大街上的芸芸众生都是业余的专家，都能够灵活而敏捷地处理个人健康护理、经济行为、人际社会交往等问题，那么，我们的社会该多么不一样。
...
传统教育中，问题常被归结为方法，而答案被归结为内容。而开放性问题改变了这个局面：问题也可以是内容，并且具有独特的生活价值。

开放性问题也同样遵循全局认识的判断标准，另外还要能够激发人的好奇心，有生命力。开放性问题可以看作全局认识的一个互补。

我们来看一个反例：引发工业革命的 3 个因素分别是什么？3 个因素意味着一个确切的答案，而且不能引发好奇。
...
- 感兴趣：对知识有情感认同和现实关切，否则再好的工具也懒得拿出来。例如，了解民主不仅为了考试，而是出于对公共参与、公平正义的热情。
...
作者做了一件非常有意思的事情：按照字母表顺序，从 A 到 Z 跳跃穿梭，挑选出各个不同学科中广泛存在的、具有生活价值的学习主题。
...
我们也从思维方式的角度探究各类具有生活价值的学习，可以称之为“认知方式”（ways of knowing）。

认知方式有如欧几里得式认知，从定义、公理和已证实的定理出发的形式演绎；培根式认知，从假设开始，基于观察和思考提出一个概括性的命题；牛顿式认知，对具体情境（水资源需求、车流量与交通拥堵等），建构数学模型来描述现实情境，并通过数学推理得出各种含义及预测，最后再回归现实生活（如创设一份水资源管理计划、验证交通状况是否符合预期等）；又或者是修昔底德式认知，解释原始资料、批判性地探讨其中可能的偏见、拼接多元资料，进而建构历史叙事。
...
为了避免陷入一个学科中的特定细节，而错过了一个学科中最好的那片广袤天地，作者认为要建立新的单元体系。
